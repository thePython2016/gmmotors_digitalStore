		...
		public static function render_mobile_cart_flyout_markup() {
			...
			<div id="astra-mobile-cart-drawer" class="astra-cart-drawer">
				...
				<?php if ( class_exists( 'WooCommerce' ) ) : ?>
					<div class="astra-cart-drawer-footer">
						<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="astra-cart-drawer-view-cart-button button">
							<?php esc_html_e( 'View Cart', 'astra' ); ?>
						</a>
					</div>
				<?php endif; ?>
			</div>
